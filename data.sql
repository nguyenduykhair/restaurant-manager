...
(
	id INT IDENTITY PRIMARY KEY, --vì có IDENTITY id tăng tự động
...
-- thêm dữ liệu cho userName, passWord: này sẽ được hiển thị trong mục tài khoản  
CREATE PROC USP_GetAccountByUserName  -- tạo ra 1  store PROC 
...
-- câu query lấy dữ liệu userName, passWord lên để đăng nhập
...
-- câu query lấy dữ liệu danh sách các bàn
CREATE PROC USP_GetTableList
AS SELECT * FROM dbo.TableFood
GO

-- cập nhập thêm để test thử
...
DELETE dbo.BillInfo -- phải xóa cái billinfo này trước
